...
var churchillSpeech = {
    ...
    //I peaked at a few students code to see what was going on I used a new text editor and kept mixing up my files.  But looking at their files made me even more confused.  I went with this because most of the text said "use one parameter" most peopke in the first one seem to be using two.  I went with the "i" variable because I thought it was the only way to do one.
